...
data_canale_borough <- data_borough_large
data_canale_CT <- data_CT_large
data_canale_DA_1 <- data_DA_1_large
data_canale_DA_2 <- data_DA_2_large

qsavem(data_canale_borough, data_canale_CT, data_canale_DA_1, data_canale_DA_2,
       file = "data/data_canale.qsm")
